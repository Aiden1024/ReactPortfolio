const cn = {
    ...
    About: {
        ...
        WorkExp: {
            ...
            Type:"实习",
            Description1:"实习期间参与《深圳广电数科AI工具实验室》的功能解析与代码注释。\n从以上项目了解到Vue，React的框架开发，并用所学知识开发了个人网站。"
        },
    },
    ...
    Portfolio: {
        ...
        Project3: {
            ...
            ProjectDescription: "未完成的UTM的华人社团管理APP，为效率管理而生，因运维人力而卒。",
        ...
        Project5: {
            ProjectTitle: "Python数据分析项目",
            ProjectFramework: "Python, Numpy, Panda, Sklearn",
            PositionDescription:"编程",
            ProjectDescription: "多大管理系MGT301的数据分析，用Jupyter Notebook搓的一些代码，课程最终得分89。",
